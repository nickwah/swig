...
module.exports = function (indent, parentBlock, parser) {
    ...
    out += '        _output += "(function() {\\n";\n';
    out += '        _output += "var _this={compileFile: function(name) {return {render:window.templates[name]};}};\\n";\n';
    out += '        _output += "window.templates = window.templates || {};\\n";\n';
    out += '        _output += "window.templates = window.templates || {};\\n";\n';
    out += '        _output += "window.templates[\'" + __template + "\'] = function(_context, _parents) {";\n';
    out += '        _output += "var _output = \\"\\";\\n";\n';
    out += '        _output += "_parents = _parents ? _parents.slice() : [];";\n';
